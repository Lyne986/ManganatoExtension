...
//                         '<p class="home-manga-informations"> ' + (manga.title.length > 43 ? manga.title.substring(0, 43) + "..." : manga.title) + ' </p>' +
...
//     // try {
//     //     object = await getItem(key);
//     //     console.log("OBJECT HOMEJS ITEM IN STRING : " + JSON.stringify(object));
//     //     mangaObj = JSON.parse(object);
//     // } catch (e) {
//     //     console.log("Something Went Wrong when getting the localstorage object");
//     // }
...
//     //         } else {
//     //             window.open(baseUrl + "manga-" + mangaObj[i].mangaCode);
//     //         }
//     //     }
//     // }
// // };
